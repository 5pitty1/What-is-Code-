...
def _write_array_header(fp, d, version: Optional[Any] = ...):
...
def write_array(fp, array, version: Optional[Any] = ..., allow_pickle: bool = ..., pickle_kwargs: Optional[Any] = ...):
    """
...
def read_array(fp, allow_pickle: bool = ..., pickle_kwargs: Optional[Any] = ...):
    """
...
def open_memmap(filename, mode=..., dtype: Optional[Any] = ..., shape: Optional[Any] = ..., fortran_order: bool = ..., version: Optional[Any] = ...):
    """
