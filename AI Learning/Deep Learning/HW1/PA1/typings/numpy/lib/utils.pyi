...
class _Deprecate(object):
    ...
    """
    def __init__(self, old_name: Optional[Any] = ..., new_name: Optional[Any] = ..., message: Optional[Any] = ...):
        self.old_name = ...
        self.new_name = ...
        self.message = ...
...
_namedict = None
_dictlist = None
def _makenamedict(module=...):
    ...

def _info(obj, output=...):
...
@set_module('numpy')
def info(object: Optional[Any] = ..., maxwidth=..., output=..., toplevel=...):
    """
...
@set_module('numpy')
def lookfor(what, module: Optional[Any] = ..., import_modules: bool = ..., regenerate: bool = ..., output: Optional[Any] = ...):
    """
